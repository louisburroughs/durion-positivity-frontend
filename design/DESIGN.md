...
## 7. Accessibility & Contrast (ADR-0039)

As per **ADR-0039**, all information-bearing text must meet WCAG 2.2 AA contrast thresholds in every supported theme and state (normal, hover, focus, active, disabled, and validation/error):

- **Small Text** (less than 18pt, or less than 14pt when bold): Minimum contrast ratio of **4.5:1**.
- **Large Text** (18pt and above, or 14pt and above when bold): Minimum contrast ratio of **3:1**.

These rules apply to any text that conveys meaning, status, instructions, value, or action. Use verified design tokens for these foreground/background pairings rather than ad-hoc color values to ensure ADA/WCAG compliance.
