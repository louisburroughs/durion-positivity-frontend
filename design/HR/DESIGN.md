...
Our typography is a dialogue between the structural strength of Barlow Semi Condensed (represented by the `publicSans` tokens) and the functional clarity of Noto Sans (represented by `inter`).
