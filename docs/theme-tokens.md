...
This file documents every CSS custom property used in the application. Tokens defined in `src/styles.css` fall into three tiers:
...
| `--input-focus-border` | blue-500 | blue-400 | Focus ring colour |
