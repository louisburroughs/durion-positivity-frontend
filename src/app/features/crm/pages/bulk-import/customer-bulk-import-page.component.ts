...
/** CUSTOMER bulk-import wizard; all behaviour lives in {@link BulkImportWizardPageBase}. */
@Component({
  selector: 'app-customer-bulk-import-page',
  templateUrl: './customer-bulk-import-page.component.html',
...
export class CustomerBulkImportPageComponent extends BulkImportWizardPageBase {
  readonly domainType: DomainType = 'CUSTOMER';
}
