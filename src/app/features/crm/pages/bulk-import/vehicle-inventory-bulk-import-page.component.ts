...
/** VEHICLE_INVENTORY bulk-import wizard; all behaviour lives in {@link BulkImportWizardPageBase}. */
@Component({
...
export class VehicleInventoryBulkImportPageComponent extends BulkImportWizardPageBase {
  readonly domainType: DomainType = 'VEHICLE_INVENTORY';
}
