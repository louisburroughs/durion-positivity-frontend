...
/** CATALOG bulk-import wizard; all behaviour lives in {@link BulkImportWizardPageBase}. */
@Component({
...
export class CatalogBulkImportPageComponent extends BulkImportWizardPageBase {
