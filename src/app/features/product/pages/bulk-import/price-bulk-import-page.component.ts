...
/** PRICE bulk-import wizard; all behaviour lives in {@link BulkImportWizardPageBase}. */
@Component({
  selector: 'app-price-bulk-import-page',
  templateUrl: './price-bulk-import-page.component.html',
...
export class PriceBulkImportPageComponent extends BulkImportWizardPageBase {
  readonly domainType: DomainType = 'PRICE';
}
