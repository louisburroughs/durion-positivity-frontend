...
/** PEOPLE bulk-import wizard; all behaviour lives in {@link BulkImportWizardPageBase}. */
@Component({
  selector: 'app-people-bulk-import-page',
  templateUrl: './people-bulk-import-page.component.html',
...
export class PeopleBulkImportPageComponent extends BulkImportWizardPageBase {
  readonly domainType: DomainType = 'PEOPLE';
}
