...
/** LOCATION bulk-import wizard; all behaviour lives in {@link BulkImportWizardPageBase}. */
@Component({
  selector: 'app-location-bulk-import-page',
  templateUrl: './location-bulk-import-page.component.html',
...
export class LocationBulkImportPageComponent extends BulkImportWizardPageBase {
  readonly domainType: DomainType = 'LOCATION';
}
