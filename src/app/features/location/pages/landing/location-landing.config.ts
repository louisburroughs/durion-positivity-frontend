    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          kind: 'direct',
          icon: 'map',
          titleKey: 'LOCATION.LANDING.CARD.SERVICE_AREAS.TITLE',
          descriptionKey: 'LOCATION.LANDING.CARD.SERVICE_AREAS.DESCRIPTION',
          ctaKey: 'LOCATION.LANDING.ACTION.OPEN_PAGE',
          route: '/app/location/service-areas',
          permissions: LOCATION_PAGE.serviceAreas,
        },
        {
          kind: 'direct',
          icon: 'timer',
          titleKey: 'LOCATION.LANDING.CARD.TRAVEL_BUFFER_POLICIES.TITLE',
          descriptionKey: 'LOCATION.LANDING.CARD.TRAVEL_BUFFER_POLICIES.DESCRIPTION',
          ctaKey: 'LOCATION.LANDING.ACTION.OPEN_PAGE',
          route: '/app/location/travel-buffer-policies',
          permissions: LOCATION_PAGE.travelBufferPolicies,
        },
        {
          kind: 'direct',
          icon: 'warehouse',
